...
import { bookingColumnsTraveler } from "./BookingColumnsTraveler";

interface bookingTableProps {
    booking: TBooking[]
}

const BookingTableTraveler = ({ booking }: bookingTableProps) => {
    ...
    return (
        <>
            <ManagementTable
                data={booking}
                columns={bookingColumnsTraveler}
...
export default BookingTableTraveler;
