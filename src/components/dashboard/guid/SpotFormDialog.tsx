...
import { createSpot, updateSpot } from "@/service/spotManagement/spotManagement";
...
const CreateSpotFormDialog = ({ open, onClose, onSuccess, spot }: ICreateSpotFormDialogProps) => {
