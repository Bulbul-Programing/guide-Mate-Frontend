    ...
    return (
        <div className="relative w-full h-screen">
            ...
            {/* <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                <p className="text-secondary-foreground text-sm mb-2">LET&apos;S TRAVEL THE WORLD WITH US</p>
                <h1 className="text-secondary-foreground text-5xl md:text-6xl font-bold mb-2">
                    EXPLORE ROME WITH
                </h1>
                <h2 className="text-secondary-foreground text-5xl md:text-6xl font-extrabold tracking-widest mb-10 opacity-80">
                    TRAVOL
                </h2>
            </div> */}
            <HeroSlider />
